...
import 'package:inteligenciaindustrialapp/src/app/screens/intro/end_screen.dart';
...
class IntroCalculatorScreen extends StatefulWidget {
  @override
  _IntroCalculatorScreenState createState() => _IntroCalculatorScreenState();
}

class _IntroCalculatorScreenState extends State<IntroCalculatorScreen> {
      ...
      children: <Widget>[
        ...
        Align(
          ...
          child: _buildActionButton(
              text: 'Próximo',
              action: () {
                frwkNavigator.navigate(EndScreen(), modal: true);
              }),
        )
      ],
    );
