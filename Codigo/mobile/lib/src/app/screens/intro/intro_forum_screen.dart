...
import 'package:inteligenciaindustrialapp/src/app/screens/intro/intro_calculator_screen.dart';
...
class IntroForumScreen extends StatefulWidget {
  @override
  _IntroForumScreenState createState() => _IntroForumScreenState();
}

class _IntroForumScreenState extends State<IntroForumScreen> {
      ...
      children: <Widget>[
        ...
        Align(
          ...
          child: _buildActionButton(
              text: 'Próximo',
              action: () {
                frwkNavigator.navigate(IntroCalculatorScreen(), modal: true);
              }),
        )
      ],
    );
